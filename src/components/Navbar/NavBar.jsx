...
const NavBar = () => {
  return (
    <div className="flex-[1.2] bg-[#242424]">
      <div className="top-nav mb-5 p-5">
      ...
      <div className="bottom-nav">
        <h1 className="text-white/50 px-5 text-[20px] font-[600]">My Collections</h1>
        ...
        <div className="setions border-t border-[#9F9F9F] p-5 flex items-center justify-between">
          ...
          <div className="toggle flex  items-center  gap-x-1">
            <BsFillSunFill className="text-neutral-500" />
            <input
              ...
              checked
            />
            <PiMoonFill className="text-[#F9762D]" />
          </div>
        </div>
      </div>
    </div>
